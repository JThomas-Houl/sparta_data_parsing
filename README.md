...
## Introduction
This set of work involves rspec testing. it begun with unit testing and arrived at intergration  / API testing. Within this repo you will find examples of array, hash and json data usage and manipulation.
